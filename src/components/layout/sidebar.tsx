  ...
  return (
    <aside className="flex h-full flex-col">
      <div className="px-5 pb-4 pt-6">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-cyan-700">Sai Associates</p>
        <h1 className="mt-2 text-lg font-semibold text-slate-900">Management System</h1>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-cyan-600 text-white shadow-[0_8px_24px_rgba(8,145,178,.25)]"
