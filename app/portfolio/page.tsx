      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="heading-2 text-dark-900 mb-4">Want to Be Our Next Success Story?</h2>
            <p className="subheading text-dark-600">Let&apos;s discuss your project and create something amazing together.</p>
          </div>
