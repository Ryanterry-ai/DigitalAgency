...
const values = [
  {
    ...
    description: 'Your success is our success. We measure our performance by the results we deliver.',
  },
  {
    icon: Icons.Sparkles,
  ...
  },
  {
    ...
    description: 'No hidden fees, no surprises. We keep you informed at every step.',
  },
  {
    icon: Icons.Rocket,
    title: 'Innovation-Driven',
    description: 'We stay ahead of trends to bring you the latest and most effective solutions.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-dark-600">
                ...
                <p>
                  We started as a two-person team working from a small office, helping neighborhood shops build their first websites. Today, we&apos;ve grown into a full-service digital agency with 15+ team members and 150+ successful projects.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-dark-900 to-dark-800 rounded-3xl p-8 text-white">
                <div className="text-center mb-8">
                  ...
                  <p className="text-dark-400">Mathura, UP</p>
                </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="heading-2 text-dark-900 mt-3 mb-4">Meet the Experts Behind Your Success</h2>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="heading-2 text-dark-900 mt-3 mb-4">The Principles We Live By</h2>
          </div>
