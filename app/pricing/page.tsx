        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card
                key={index}
                className={`relative overflow-hidden ${plan.popular ? 'ring-2 ring-primary-500' : ''}`}
              >
                {plan.popular && (
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-3 text-dark-900 mb-4">Frequently Asked Questions</h2>
            </div>
            
            <div className="space-y-4">
              {[
                { q: 'What payment methods do you accept?', a: 'We accept UPI, Bank Transfer, Credit/Debit Cards, and partial EMI options for larger projects.' },
                { q: 'Is there a refund policy?', a: 'Yes! If you&apos;re not satisfied with our work within the first 15 days, we offer a full refund.' },
                { q: 'How long does a typical project take?', a: 'Starter: 7-14 days. Growth: 2-4 weeks. Premium: 4-8 weeks.' },
                { q: 'Do you provide post-launch support?', a: 'Yes! All packages include free support period. Premium clients get dedicated support for 12 months.' },
                { q: 'Can I upgrade my package later?', a: 'Absolutely! You can upgrade at any time.' },
              ].map((faq, index) => (
      ...
      <section className="section-padding bg-gradient-to-br from-primary-600 to-accent-600">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="subheading text-white/80 mb-8">Get a personalized quote and recommendations.</p>
